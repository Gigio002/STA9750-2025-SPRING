...
+-------------+---------------+------------------+------------------+
| **Mode**    | **Total BTU** | **PMT (Passenger | **Energy         |
|             |               | Miles)**         | Efficiency (BTU  |
|             |               |                  | per PMT)**       |
+-------------+---------------+------------------+------------------+
...
+-------------+---------------+------------------+------------------+
| **Rail**    | 312,745,000   | 1,200,000        | **260.62** (Most |
|             |               |                  | Efficient)       |
+-------------+---------------+------------------+------------------+
...
+----------+----------+----------+----------+----------+----------+
| **Mode** | **Diesel | **       | *        | **Total  | **Total  |
|          | CO₂      | Gasoline | *Natural | CO₂      | CO₂      |
|          | (lbs)**  | CO₂      | Gas CO₂  | (lbs)**  | (metric  |
|          |          | (lbs)**  | (lbs)**  |          | tons)**  |
+----------+----------+----------+----------+----------+----------+
| **Bus**  | 22,450   | 14,984   | 72,510   | **1      | *        |
|          |          |          |          | 09,944** | *49.87** |
+----------+----------+----------+----------+----------+----------+
| **Rail** | 11,225   | 5,619    | 24,170   | **       | *        |
|          |          |          |          | 41,014** | *18.60** |
+----------+----------+----------+----------+----------+----------+
| **V      | 4,490    | 1,873    | 6,043    | **       | **5.63** |
| anpool** |          |          |          | 12,406** |          |
+----------+----------+----------+----------+----------+----------+
...
+---------+---------+---------+---------+---------+---------+---------+
| **M     | **Min** | **1st   | **M     | *       | **3rd   | **Max** |
| etric** |         | Qua     | edian** | *Mean** | Qua     |         |
|         |         | rtile** |         |         | rtile** |         |
+---------+---------+---------+---------+---------+---------+---------+
| **CO₂   | 12,406  | 26,710  | 41,014  | 54,454  | 75,479  | 109,944 |
| per UPT |         |         |         |         |         |         |
| (lbs)** |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
...
+----------+-------------+----------+--------------------------+
| **Rank** | **Agency**  | **Mode** | **CO₂ per PMT (lbs)**    |
+----------+-------------+----------+--------------------------+
| 1️⃣       | Amtrak      | Rail     | **0.0342**               |
+----------+-------------+----------+--------------------------+
| 2️⃣       | Vanpool Co. | Vanpool  | **0.0827**               |
+----------+-------------+----------+--------------------------+
| 3️⃣       | MTA         | Bus      | **0.2199**               |
+----------+-------------+----------+--------------------------+
